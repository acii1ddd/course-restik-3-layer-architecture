...
namespace DAL.PostgresRepositories
{
    internal class OrderArchiveRepository : IOrderArchiveRepository
    {
        ...
        public OrderArchiveRepository(string connectionString)
        {
        ...
        public void Add(Order entity)
        {
            ...
            {
                connection.Open();
                var query = "INSERT INTO orders_archive (client_id, table_number) " +
        ...
        public void Delete(Order entity)
        {
            ...
            {
                connection.Open();
                var query = "DELETE FROM orders_archive WHERE id = @id";
        ...
        public IEnumerable<Order> GetAll()
        {
            ...
            {
                connection.Open();
                var query = "SELECT * FROM orders_archive";
                using (var command = new NpgsqlCommand(query, connection))
                {
                    using (var reader = command.ExecuteReader())
                    {
        ...
        public void Update(Order entity)
        {
            ...
            {
                connection.Open();
                var query = "UPDATE orders_archive SET " +
                            "client_id = @client_id, " +
                            "date = @date, " +
