...
namespace DAL.Configuration
{
    public static class ConfigurationExtensions
    {
        ...
        public static void ConfigureMongo(this IServiceCollection services, string connection, string databaseName)
        {
            ...
            services.AddScoped<IOrderItemArchiveRepository>(provider => new DAL.MongoRepositories.OrderItemArchiveRepository(connection, databaseName, "orders_items_archive"));
